...
export default function PremiumLandingPage() {
  ...
  }, [floatY, logoOpacity, logoScale, isAuthenticated, router]);
  ...
  return (
    <ScrollView style={styles.container} bounces={false}>
      ...
      >
        ...
        {/* Logo Container */}
        <Animated.View style={[styles.logoContainer, logoAnimatedStyle as any]}>
          <Image
        ...
        <Animated.View entering={FadeIn.delay(500).duration(800)}>
          ...
          <Text style={styles.heroSubtitle}>Where Every Tail Has a Story</Text>
        </Animated.View>
        ...
        >
          ...
          <TouchableOpacity
            ...
            activeOpacity={0.8}
          >
            <Text style={styles.heroSignInButtonText}>Login</Text>
          </TouchableOpacity>
        </Animated.View>
      </LinearGradient>
