...
export default function SettingsScreen() {
  ...
  const handleRateApp = () => {
    showModal({
      ...
      message:
        'App store rating functionality will be available after release!',
      type: 'info',
      icon: 'star',
      actions: [{ text: 'Got it', style: 'primary', onPress: hideModal }],
    });
          ...
          onPress: () => {
            ...
            setTimeout(() => {
              showModal({
                ...
                title: 'Data Reset',
                message:
                  'Data reset functionality will be available in the next update!',
                type: 'info',
                icon: 'refresh',
                actions: [
                  { text: 'Got it', style: 'primary', onPress: hideModal },
                ],
              });
            }, 300);
          },
          ...
          onPress: () => {
            ...
            setTimeout(() => {
              showModal({
                ...
                title: 'Sign Out',
                message:
                  'Sign out functionality will be available in the next update!',
                type: 'info',
                icon: 'log-out',
                actions: [
                  { text: 'Got it', style: 'primary', onPress: hideModal },
