...
module.exports = {
  ...
  apps: {
    'ios.debug': {
      type: 'ios.app',
      binaryPath:
        'ios/build/Build/Products/Debug-iphonesimulator/TailTracker.app',
      build:
        'xcodebuild -workspace ios/TailTracker.xcworkspace -scheme TailTracker -configuration Debug -sdk iphonesimulator -derivedDataPath ios/build',
    },
    'ios.release': {
      type: 'ios.app',
      binaryPath:
        'ios/build/Build/Products/Release-iphonesimulator/TailTracker.app',
      build:
        'xcodebuild -workspace ios/TailTracker.xcworkspace -scheme TailTracker -configuration Release -sdk iphonesimulator -derivedDataPath ios/build',
    },
    'android.debug': {
      type: 'android.apk',
