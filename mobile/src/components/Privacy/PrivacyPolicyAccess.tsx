...
export const PrivacyPolicyAccess: React.FC<PrivacyPolicyAccessProps> = ({
  ...
  const openPrivacyPolicy = async () => {
    const privacyUrl = 'https://tailtracker.app/privacy-policy';
    ...
    try {
      ...
      if (canOpen) {
        ...
        Alert.alert(
          'Unable to Open',
          'Please visit tailtracker.app/privacy-policy in your web browser to view our Privacy Policy.',
          [{ text: 'OK' }]
        );
      }
    } catch (error) {
      Alert.alert(
        'Error',
        'Unable to open Privacy Policy. Please visit tailtracker.app/privacy-policy in your web browser.',
        [{ text: 'OK' }]
      );
    }
  };
