  ...
  const handleResetPassword = async () => {
    ...
    try {
      ...
      if (result.success) {
        ...
        showError(
          'Reset Failed',
          result.error || 'Unable to send reset email. Please check your email address and try again.',
          'alert-circle'
        );
      }
    } catch {
        ...
        {!resetSent ? (
          ...
          <View style={styles.successContainer}>
            ...
            <Text style={styles.successInstructions}>
              Check your email (including spam folder) and click the reset link to create a new password.
            </Text>
