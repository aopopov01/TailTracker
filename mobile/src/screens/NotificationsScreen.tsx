...
interface Notification {
  id: string;
  type: 'lost_pet' | 'vaccination' | 'system' | 'social' | 'emergency' | 'reminder';
  title: string;
  message: string;
  timestamp: Date;
  read: boolean;
...
export const NotificationsScreen: React.FC = () => {
  ...
  const loadSettings = useCallback(async () => {
    try {
      const [pushEnabled, soundEnabled, vibrationEnabled, quietHoursStart, quietHoursEnd] = await Promise.all([
  ...
  const filterNotifications = useCallback(() => {
    ...
    switch (filter) {
      ...
      case 'urgent':
        ...
        break;
      case 'pet_related':
        filtered = notifications.filter(n => n.type === 'lost_pet' || n.type === 'vaccination');
        break;
      default:
        break;
    }
      ...
      const mockNotifications: Notification[] = [
        {
          ...
          message: 'A Golden Retriever named "Buddy" is missing near your area. Last seen at Golden Gate Park.',
        ...
        },
        {
          ...
          type: 'system',
          title: 'App Updated',
          message: 'TailTracker has been updated with new features and bug fixes.',
        ...
        },
        {
          ...
          message: 'Your photo of Bella received 12 likes from other pet owners!',
        ...
        },
        {
          ...
          message: 'Don\'t forget to check Max\'s weight and update his health profile.',
      ...
      case 'lost_pet':
        Alert.alert(
          ...
          [
            ...
            { text: 'Help Search', onPress: () => console.log('Help search for pet') },
            { text: 'Call Owner', onPress: () => console.log('Call pet owner') }
          ]
        );
        break;
      case 'vaccination':
        Alert.alert(
          ...
          [
            ...
            { text: 'Schedule Now', onPress: () => console.log('Schedule vaccination') }
          ]
        );
        break;
      case 'emergency':
        Alert.alert(
          ...
          [
            ...
            { text: 'Call Back', onPress: () => console.log('Call emergency contact') }
          ]
        );
        break;
      default:
          ...
          <View style={styles.notificationHeader}>
            ...
            <View style={styles.notificationContent}>
              <View style={styles.notificationTitleRow}>
                ...
                <View style={styles.notificationMeta}>
                  {item.priority === 'urgent' && (
                    <Badge style={[styles.urgentBadge, { backgroundColor: theme.colors.error }]}>
                      URGENT
                    </Badge>
                  )}
              ...
              {item.petName && (
                <Chip
                  icon="paw"
                  style={[styles.petChip, { backgroundColor: theme.colors.primaryContainer }]}
              ...
              {item.metadata?.location && (
                <View style={styles.metadataRow}>
                  ...
                  <Text style={[styles.metadataText, { color: theme.colors.onSurfaceVariant }]}>
                    {item.metadata.location}
                    {item.metadata.distance && ` (${item.metadata.distance}km away)`}
                  </Text>
                </View>
              )}
            </View>
    ...
    <Card style={[styles.settingsCard, { backgroundColor: theme.colors.surface }]}>
      <Card.Content>
        ...
        <TouchableOpacity 
          ...
          onPress={() => Alert.alert('Quiet Hours', 'Quiet hours feature coming soon!')}
        >
          <View>
            <Text style={[styles.settingLabel, { color: theme.colors.onSurface }]}>
              Quiet Hours
  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      ...
      <View style={styles.filterContainer}>
        {(['all', 'unread', 'urgent', 'pet_related'] as FilterType[]).map((filterType) => (
          <Chip
            key={filterType}
          ...
          >
            {filterType === 'pet_related' ? 'Pet Related' : 
