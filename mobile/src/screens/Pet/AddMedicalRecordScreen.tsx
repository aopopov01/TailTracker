...
export default function AddMedicalRecordScreen() {
  ...
  const saveRecord = async () => {
    if (!formData.title.trim()) {
      Alert.alert('Validation Error', 'Please enter a title for this medical record.');
      return;
    }
        ...
        {RECORD_TYPES.map((type) => (
          ...
          >
            <Ionicons
              ...
              size={20}
              color={formData.type === type.value ? colors.primary : colors.gray400}
            />
            <Text
              style={[
    ...
    <View style={styles.formSection}>
      ...
      {attachments.length > 0 ? (
        ...
        <Text style={styles.noAttachmentsText}>
          No attachments added. You can attach documents, images, or test results.
        </Text>
      )}
    </View>
  );
        ...
        >
          ...
          <View style={styles.formSection}>
            ...
            {renderFormField(
              ...
              { 
                placeholder: 'Describe the medical procedure, diagnosis, or treatment',
                multiline: true,
                numberOfLines: 4,
                required: true
              }
            ...
            {renderFormField(
              ...
              { 
                placeholder: 'Any additional information, follow-up instructions, etc.',
                multiline: true,
                numberOfLines: 3
              }
            )}
