...
export default function AppPreferencesScreen() {
  ...
  const savePreferences = async (newPreferences: AppPreferences) => {
    try {
      setLoading(true);
      await AsyncStorage.setItem('appPreferences', JSON.stringify(newPreferences));
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        {renderPickerSetting(
          ...
          (value: 'small' | 'medium' | 'large') => updatePreference('fontSize', value)
        )}
        ...
        <View style={styles.previewSection}>
          ...
          <View style={styles.previewCard}>
            ...
            <Text style={styles.previewDate}>
              {preferences.dateFormat === 'MM/DD/YYYY' ? '12/31/2024' :
               preferences.dateFormat === 'DD/MM/YYYY' ? '31/12/2024' : '2024-12-31'}
            </Text>
            <Text style={styles.previewTemp}>
              Temperature: {preferences.temperatureUnit === 'celsius' ? '22°C' : '72°F'}
            </Text>
