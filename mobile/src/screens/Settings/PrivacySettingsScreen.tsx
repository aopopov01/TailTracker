  ...
  const [privacySettings, setPrivacySettings] = useState<PrivacySetting[]>([
    {
      ...
      description: 'Allow TailTracker to track your pet\'s location for safety features',
      value: true,
      isRequired: false,
    },
    {
    ...
    },
    {
      ...
      description: 'Allow emergency contacts to access pet information in crises',
      value: true,
      isRequired: false,
    },
  ]);
        ...
        <View style={styles.section}>
          ...
          <View style={styles.infoCard}>
            ...
            <View style={styles.infoContent}>
              ...
              <Text style={styles.infoDescription}>
                ...
                All pet data is stored securely and only shared with your explicit consent.
              </Text>
            </View>
          </View>
          ...
          <View style={styles.infoCard}>
            ...
            <View style={styles.infoContent}>
              ...
              <Text style={styles.infoDescription}>
                We only collect data necessary for app functionality and your pet's safety. 
                You can control what information is shared and with whom.
              </Text>
            </View>
          </View>
          ...
          <View style={styles.infoCard}>
            ...
            <View style={styles.infoContent}>
              ...
              <Text style={styles.infoDescription}>
                Pet medical records are kept for 7 years for veterinary purposes. 
                Other data is deleted after 2 years of account inactivity.
              </Text>
            </View>
          </View>
        </View>
