    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        <View style={styles.introSection}>
          ...
          <Text style={styles.lastUpdated}>Last Updated: {privacyPolicyContent.lastUpdated}</Text>
        ...
        <View style={styles.footer}>
          <Text style={styles.footerText}>
            This privacy policy is written in plain language to ensure clarity and understanding.
            For questions about specific technical or legal aspects, please contact our Data Protection Officer.
          </Text>
        </View>
      </ScrollView>
    </SafeAreaView>
