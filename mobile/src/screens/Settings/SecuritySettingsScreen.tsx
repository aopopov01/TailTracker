    ...
    if (settingId === 'biometric_auth' && newValue && biometricAvailable) {
      try {
        ...
        if (result.success) {
          ...
          Alert.alert('Authentication Failed', 'Please try again to enable biometric authentication.');
        }
      } catch (error) {
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.section}>
          ...
          <TouchableOpacity style={styles.actionButton} onPress={enableTwoFactor}>
          ...
          <TouchableOpacity style={styles.actionButton} onPress={viewActiveSessions}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.statusCard}>
            ...
            <Text style={styles.statusDescription}>
              Your account has strong security settings enabled. Keep your password safe and enable two-factor authentication for maximum protection.
            </Text>
          </View>
