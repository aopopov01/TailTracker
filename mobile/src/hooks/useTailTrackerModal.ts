...
export const useTailTrackerModal = () => {
  ...
  const showInfo = (title: string, message: string, icon?: keyof typeof Ionicons.glyphMap) => {
    showModal({
      title,
      message,
      type: 'info',
  ...
  const showWarning = (title: string, message: string, icon?: keyof typeof Ionicons.glyphMap) => {
    showModal({
      title,
      message,
      type: 'warning',
