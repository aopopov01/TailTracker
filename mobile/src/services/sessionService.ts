...
export class SessionService {
  ...
  static async updateSessionUser(user: User): Promise<void> {
    try {
      ...
      await SecureStore.setItemAsync(this.SESSION_KEY, JSON.stringify(updatedSession));
    } catch (error) {
  ...
  static async extendSession(): Promise<void> {
    try {
      ...
      await SecureStore.setItemAsync(this.SESSION_KEY, JSON.stringify(extendedSession));
    } catch (error) {
