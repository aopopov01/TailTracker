...
const errorMessages: Record<PaymentErrorCode, { message: string; userMessage: string; recoverable: boolean; retryable: boolean }> = {
  ...
  [PaymentErrorCode.SERVICE_UNAVAILABLE]: {
    ...
    userMessage: 'Payment services are temporarily unavailable. Please try again later.',
    recoverable: true,
    retryable: true,
  },
  ...
  [PaymentErrorCode.SUBSCRIPTION_CANCELED]: {
    ...
    userMessage: 'Your subscription has been canceled. You can resubscribe anytime.',
    recoverable: true,
    retryable: false,
  },
  [PaymentErrorCode.PRODUCT_NOT_FOUND]: {
    message: 'Product not found',
    userMessage: 'The selected plan is not available. Please try a different option.',
    recoverable: false,
    retryable: false,
  },
  ...
  [PaymentErrorCode.STORE_CONNECTION_FAILED]: {
    ...
    userMessage: 'Cannot connect to the app store. Please check your connection.',
    recoverable: true,
    retryable: true,
  },
...
export function createPaymentError(
  ...
  const errorInfo = errorMessages[code] || errorMessages[PaymentErrorCode.UNKNOWN_ERROR];
