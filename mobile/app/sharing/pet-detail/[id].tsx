...
const SharedPetDetailScreen: React.FC = () => {
  ...
  const calculateAge = (birthDate: Date | undefined, approximateAge: string | undefined, useApproximate: boolean | undefined) => {
  ...
  const renderInfoItem = (label: string, value: string | undefined, fallback: string = 'Not specified') => (
      ...
      <View style={styles.contactCard}>
        ...
        {contact.name && (
          <Text style={styles.contactDetail}>
            <MaterialIcons name="person" size={16} color="#8E8E93" /> {contact.name}
          </Text>
        )}
        {contact.phone && (
          <Text style={styles.contactDetail}>
            <MaterialIcons name="phone" size={16} color="#8E8E93" /> {contact.phone}
          </Text>
        )}
        {contact.address && (
          <Text style={styles.contactDetail}>
            <MaterialIcons name="location-on" size={16} color="#8E8E93" /> {contact.address}
          </Text>
        )}
      </View>
    );
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.petHeader}>
          ...
          <View style={styles.petHeaderInfo}>
            ...
            <Text style={styles.petAge}>
              {calculateAge(pet.dateOfBirth, pet.approximateAge, pet.useApproximateAge)}
            </Text>
          </View>
        </View>

        {/* Basic Information */}
        {renderInfoSection('Basic Information', 'info', (
          <>
        ...
        {/* Health Information */}
        {renderInfoSection('Health Information', 'medical-services', (
          <>
        ...
        {/* Care Information */}
        {renderInfoSection('Care Information', 'favorite', (
          <>
            ...
            {pet.specialNotes && renderInfoItem('Special Notes', pet.specialNotes)}
          </>
        ))}
