...
export default function CommunityAlertsScreen() {
  ...
  const loadCommunityAlerts = async () => {
    try {
      // TODO: Load real alerts from Supabase
        ...
        [
          { text: 'Cancel', style: 'cancel' },
          {
            ...
            onPress: () => {
              ...
              Alert.alert(
                'Calling...',
                `This would dial ${alert.contactPhone}`
              );
            },
          },
        ]
      ...
      [
        { text: 'Cancel', style: 'cancel' },
        {
          ...
          onPress: () => {
            Alert.alert(
              'Thank You!',
              'Your sighting report has been sent to the pet owner. They will contact you soon.'
            );
          },
        },
      ]
      ...
      <View style={styles.alertHeader}>
        <View style={styles.alertInfo}>
          ...
          <Text style={styles.petDetails}>
            {alert.petSpecies} • {alert.petBreed}
          </Text>
    ...
    <ScrollView style={styles.container}>
        ...
        {alerts.length === 0 ? (
          <View style={styles.emptyState}>
            ...
            <Text style={styles.emptySubtitle}>
              Great news! There are currently no missing pets in your area.
              Check back later to help reunite pets with their families.
            </Text>
          </View>
        ) : (
      ...
      <View style={styles.infoSection}>
        ...
        <Text style={styles.infoText}>
          ...
          {'\n'}• Help pet owners by reporting sightings and providing contact
          information{'\n'}• Pro tier users can report their own lost pets to
          the community{'\n'}• All users receive community alerts to help
          reunite families{'\n'}• Contact pet owners directly or report
