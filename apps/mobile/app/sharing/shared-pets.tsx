...
type SharedPetWithOwner = SharedPetAccess;
    ...
    <SafeAreaView style={styles.container}>
        ...
        {sharedPets.length === 0 ? (
          <View style={styles.emptyContainer}>
            ...
            <Text style={styles.emptyText}>
              When others share their pet information with you, it will appear
              here.
            </Text>
          </View>
        ) : (
          <>
            <View style={styles.statsContainer}>
              <Text style={styles.statsText}>
                {sharedPets.length} pet{sharedPets.length !== 1 ? 's' : ''}{' '}
                shared with you
              </Text>
            </View>
      ...
      <View style={styles.infoBanner}>
        ...
        <Text style={styles.infoBannerText}>
          You have read-only access to shared pets. Contact the owner to update
          information.
        </Text>
      </View>
    </SafeAreaView>
