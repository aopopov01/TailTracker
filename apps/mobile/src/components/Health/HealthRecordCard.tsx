...
// NOTE: Using medical_records as base since health_records table doesn't exist
type MedicalRecord = Database['public']['Tables']['medical_records']['Row'];

interface HealthRecord extends Omit<MedicalRecord, 'document_urls'> {
  weight?: number;
  temperature?: number;
  notes?: string;
  veterinarian?: {
    ...
    >
      <View style={styles.header}>
        <View style={styles.titleContainer}>
          ...
          <Text style={styles.date}>{formatDate(record.date_of_record)}</Text>
        </View>
