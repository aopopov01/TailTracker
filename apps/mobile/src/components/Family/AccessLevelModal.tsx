...
import familyAccessService, {
  type UserRole,
} from '@/services/FamilyAccessService';

// NOTE: AccessLevel doesn't exist - using UserRole instead
type AccessLevel = UserRole;
...
export const AccessLevelModal: React.FC<AccessLevelModalProps> = ({
  ...
  const [selectedAccessLevel, setSelectedAccessLevel] =
    useState<AccessLevel>('viewer'); // NOTE: viewer = read-only, member = read/write
  ...
  const handleConfirmAccess = async () => {
    ...
    try {
      ...
      // NOTE: confirmFamilyMemberAccess method doesn't exist yet - using stub
      // TODO: Implement proper family invitation confirmation
      const result = {
        success: false,
        error: 'Family invitation confirmation not yet implemented',
      };
      ...
      if (result.success) {
        Alert.alert(
          'Access Granted!',
          `${pendingMember.user?.full_name || 'Family member'} now has ${selectedAccessLevel === 'viewer' ? 'read-only' : 'read and write'} access to your family's pet information.`,
          [
            {
              text: 'OK',
              onPress: () => {
          ...
          <View style={styles.modalBody}>
                ...
                <View style={styles.radioOption}>
                  ...
                  <View style={styles.radioContent}>
                    ...
                    <Text
                      ...
                      style={{ color: theme.colors.onSurfaceVariant }}
                    >
                      Can view pet profiles, health records, and photos. Cannot
                      make changes.
                    </Text>
                  </View>
                </View>
                ...
                <View style={styles.radioOption}>
                  ...
                  <View style={styles.radioContent}>
                    ...
                    <Text
                      ...
                      style={{ color: theme.colors.onSurfaceVariant }}
                    >
                      Can view and edit pet profiles, add health records, and
                      upload photos.
                    </Text>
                  </View>
                </View>
            ...
            >
              <Card.Content>
                ...
                >
                  💡 You can change their access level later from Family
                  Settings.
                </Text>
              </Card.Content>
            </Card>
            ...
            {selectedAccessLevel === 'member' && (
              ...
              >
                <Card.Content>
                  ...
                  >
                    ⚠️ Read & Write access allows this person to modify pet
                    information, add health records, and upload photos.
                  </Text>
                </Card.Content>
              </Card>
            )}
