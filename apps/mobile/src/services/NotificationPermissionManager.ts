  ...
  async requestPermissions(
    ...
    try {
      ...
      if (granted) {
        ...
        const wasFirstDenial =
          this.flowState === 'initial' || this.flowState === 'explained';
    ...
    switch (reason) {
      case 'lost_pet_alerts':
        return {
          ...
          message:
            'Get notified instantly when pets go missing in your area so you can help bring them home.',
          benefits: [
      ...
      case 'health_reminders':
        return {
          ...
          message:
            'Keep your pets healthy with timely reminders for medications, vaccinations, and vet appointments.',
          benefits: [
      ...
      case 'location_safety':
        return {
          ...
          message:
            'Receive important safety notifications based on your location to keep your pets secure.',
          benefits: [
      ...
      case 'emergency_alerts':
        return {
          ...
          message:
            'Get immediate alerts for pet emergencies that require urgent attention.',
          benefits: [
      ...
      case 'first_time_setup':
        return {
          ...
          message:
            'TailTracker uses notifications to keep your pets safe and healthy. Enable notifications to get the full experience.',
          benefits: [
      ...
      case 'settings_change':
        return {
          ...
          message:
            'Customize your notification settings to receive the alerts that matter most to you.',
          benefits: [
      ...
      default:
        return {
          ...
          message:
            'Allow TailTracker to send you notifications to enhance your pet care experience.',
          benefits: [
...
export const useNotificationPermissions = () => {
  ...
  const [flowState, setFlowState] =
    React.useState<PermissionFlowState>('initial');
  ...
  const checkPermissions = async (reason: PermissionReason) => {
    return await notificationPermissionManager.checkAndExplainPermissions(
      reason
    );
  };
  ...
  const showExplanation = async (reason: PermissionReason) => {
    return await notificationPermissionManager.showPermissionExplanation(
      reason
    );
  };
