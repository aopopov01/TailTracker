...
export default function EditPetScreen() {
  ...
  const loadPetData = useCallback(async () => {
    try {
      ...
      if (data) {
        // NOTE: Type assertion needed - database types differ from Pet interface
        setFormData({
          ...data,
      ...
      {showDatePicker && (
        <>
          ...
          <View style={styles.datePickerActions}>
            ...
            >
              <Text
                style={[styles.datePickerButtonText, styles.cancelButtonText]}
              >
                Cancel
              </Text>
            </TouchableOpacity>
      ...
      >
        ...
        >
          ...
          <View style={styles.formSection}>
            ...
            {renderBooleanField('Neutered/Spayed', formData.neutered, value =>
              updateField('neutered', value)
            )}
          </View>
          ...
          <View style={styles.formSection}>
            ...
            {renderFormField(
              'Weight (kg)',
              formData.weight_kg || '',
              text => updateField('weight_kg', text),
          ...
          <View style={styles.formSection}>
            ...
            {/* Dietary Restrictions field removed - not in database schema */}
          </View>
