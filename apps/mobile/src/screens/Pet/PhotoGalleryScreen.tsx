...
export default function PhotoGalleryScreen() {
  ...
  const pinchHandler = (event: any) => {
    'worklet';
    const scaleValue = Math.max(1, Math.min(event.nativeEvent.scale, 3));
    ...
    <View style={styles.emptyState}>
      ...
      <View style={styles.emptyActions}>
        ...
        >
          ...
          <Text
            style={[styles.emptyActionButtonText, styles.secondaryButtonText]}
          >
            Add Photos
          </Text>
        </TouchableOpacity>
      ...
      <View style={styles.viewerContainer}>
        ...
        <View style={styles.viewerActions}>
          ...
          >
            ...
            <Text style={[styles.viewerActionText, { color: colors.error }]}>
              Delete
            </Text>
          </TouchableOpacity>
        </View>
