        ...
        { text: 'Cancel', style: 'cancel' },
        {
          ...
          onPress: () => {
            ...
            setPet({
              ...pet,
              status: 'lost',
              lastSeen: { date: new Date(), location: 'Current Location' },
            });
            Alert.alert(
              'Lost Pet Reported',
              'Alert has been sent to nearby users.'
            );
          },
        },
      ]
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
          ...
          <Card.Content>
            <View style={styles.headerRow}>
              <View style={styles.petInfo}>
                <Text
                  style={[styles.petName, { color: theme.colors.onSurface }]}
                >
                  {pet.name}
                </Text>
                <Text
            ...
            {pet.status === 'lost' && pet.lastSeen && (
              ...
              >
                ...
                <Text style={[styles.lostText, { color: theme.colors.error }]}>
                  Last seen: {pet.lastSeen.date.toLocaleDateString()} at{' '}
          ...
          <Card.Content>
            <View style={styles.sectionHeader}>
              ...
              <Button
                mode='text'
                onPress={() =>
                  Alert.alert('Add Vaccination', 'Feature coming soon!')
                }
              >
                Add
              </Button>
        ...
        <View style={styles.actionContainer}>
          ...
          <Button
            mode='outlined'
            onPress={() =>
              navigation.navigate('LocationHistory', { petId: pet.id })
            }
