...
export class StripePaymentService {
  ...
  async initialize(): Promise<void> {
    ...
    try {
      ...
      await initStripe({
        publishableKey,
        merchantIdentifier:
          Config.APPLE_MERCHANT_ID || 'merchant.com.tailtracker.app',
      });
   ...
   */
  async createSubscriptionWithParams(
    ...
    try {
      ...
      const response = await fetch(
        `${Config.API_BASE_URL}/subscriptions/create`,
        {
          method: 'POST',
          headers: {
      ...
      console.error(
        'StripePaymentService: Failed to create subscription',
        error
      );
      throw error;
    }
  ...
  async cancelSubscription(subscriptionId: string): Promise<boolean> {
    try {
      const response = await fetch(
        `${Config.API_BASE_URL}/subscriptions/${subscriptionId}/cancel`,
        {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
      ...
      console.error(
        'StripePaymentService: Failed to cancel subscription',
        error
      );
      return false;
    }
  ...
  async getSubscriptionById(
    ...
    try {
      ...
      console.error(
        'StripePaymentService: Failed to get subscription status',
        error
      );
      return null;
    }
  ...
  async addPaymentMethod(
    ...
    try {
      ...
      console.error(
        'StripePaymentService: Failed to add payment method',
        error
      );
      return {
        id: '',
  ...
  async removePaymentMethod(paymentMethodId: string): Promise<boolean> {
    try {
      const response = await fetch(
        `${Config.API_BASE_URL}/payment-methods/${paymentMethodId}`,
        {
          method: 'DELETE',
          headers: {
            Authorization: `Bearer ${await this.getAuthToken()}`,
      ...
      console.error(
        'StripePaymentService: Failed to remove payment method',
        error
      );
      return false;
    }
  ...
  async getPaymentMethods(): Promise<StripePaymentMethod[]> {
    try {
      ...
      console.error(
        'StripePaymentService: Failed to get payment methods',
        error
      );
      return [];
    }
   ...
   */
  async validateSimpleResourceAccess(
    userId: string,
    resource: string
  ): Promise<boolean> {
    try {
      ...
      console.error(
        'StripePaymentService: Failed to validate resource access',
        error
      );
  ...
  async getSubscriptionStatus(): Promise<SubscriptionStatus> {
    try {
      const response = await fetch(
        `${Config.API_BASE_URL}/subscriptions/status`,
        {
          method: 'GET',
          headers: {
            Authorization: `Bearer ${await this.getAuthToken()}`,
  ...
  async validateResourceAccess(
    ...
    try {
      ...
      const resourceLimits: Record<
        string,
        Record<string, { limit?: number; requiresPremium: boolean }>
      > = {
        free: {
