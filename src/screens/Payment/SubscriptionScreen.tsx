...
export const SubscriptionScreen: React.FC = () => {
  ...
  const confirmCancelSubscription = async (immediately: boolean = false) => {
    try {
      ...
      const success =
        await paymentService.cancelSubscription('subscription_id'); // TODO: Get actual subscription ID
        ...
        <Card style={styles.currentSubscriptionCard}>
          <Card.Content>
            ...
            <Text style={styles.upgradePrompt}>
              Upgrade to Premium (3 family members + 2 pets) or Pro (unlimited)
              for lost pet alerts and more!
            </Text>
          </Card.Content>
        </Card>
      );
