        ...
        { text: 'Cancel', style: 'cancel' },
        {
          ...
          onPress: async () => {
            ...
            try {
              ...
              Alert.alert(
                'Cache Cleared',
                'Successfully cleared 5.7 MB of cached data.'
              );
            } catch (error) {
        ...
        <View style={styles.section}>
          ...
          <View style={styles.storageCard}>
            ...
            <Text style={styles.storageDescription}>
              Data stored locally on your device. Cloud backup is automatically
              synced.
            </Text>
          </View>
        </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.policyCard}>
            ...
            <View style={styles.policyContent}>
              ...
              <Text style={styles.policyDescription}>
                All data is encrypted at rest and in transit. Cloud backups are
                automatically encrypted with your device key.
              </Text>
            </View>
          </View>
        </View>
