...
export const SettingsScreen: React.FC = () => {
    ...
    if (newCount >= 7) {
      if (!isDeveloperMode) {
        ...
        Alert.alert(
          ...
          'Developer options are now available in the settings menu.',
          [{ text: 'OK' }]
        );
      }
      ...
      Alert.alert(
        '👩‍💻 Developer Mode',
        `Tap ${7 - newCount} more times to enable developer options`,
        [{ text: 'OK' }]
      );
    }
      ...
      items: [
        ...
        },
        {
          ...
          description: isPremium
            ...
            : 'Unlock unlimited pets and premium features',
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          type: 'toggle',
          value:
            (settings as any)?.locationSharingEnabled ||
          ...
          ? [
              {
                ...
                screen: 'DeveloperOptions' as keyof RootStackParamList,
              },
            ]
          : []),
      ],
  ...
  const renderSettingItem = (item: SettingItem) => {
    ...
    const handlePress = () => {
      ...
      if (item.screen) {
        if (item.screen === 'DeveloperOptions') {
          router.push('/settings/developer-options' as any);
        } else {
      ...
      >
        ...
        >
          <Text
            style={[
              styles.versionText,
              isDeveloperMode && styles.developerModeText,
            ]}
          >
            TailTracker v1.0.0 {isDeveloperMode && '(Developer Mode)'}
          </Text>
          <Text style={styles.buildText}>Build 100</Text>
          {versionTapCount > 0 && (
            <Text style={styles.tapCountText}>
              Tap {7 - versionTapCount} more times
            </Text>
          )}
        </TouchableOpacity>
